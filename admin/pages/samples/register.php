          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <h5 class="font-weight-medium">MED PLUS</h5>
              </div>
              <h4>Welcome to Med Plus</h4>
              <h6 class="fw-light">Sign up to continue.</h6>
              <form class="pt-3" action="../../controller/admin_register.php" method="post">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="name" placeholder="Full Name">
                </div>
                <div class="form-group">
                  <input type="phone" class="form-control form-control-lg" name="phone" placeholder="Phone Number">
                </div>
                <div class="form-group">
