...
$admin=new Admin();
$id=$_SESSION['id'];
$stmt= $admin->ret("SELECT * FROM `manage_customers` WHERE `customer_id`='$id'");
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right">
						    <span class="text">Welcome <?php echo $row['customer_name']?></span>
					    </div>
				    </div>
			    </div>
		    </div>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Medplus</h1>
	              <h2 class="subheading mb-4">Medicines at your door service</h2>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/bottle.jpg" alt="Colorlib Template">
